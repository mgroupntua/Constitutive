...
namespace MGroup.Multiscale
{
	...
	/// </summary>
	public class MicrostructureShell2D : StructuralProblemsMicrostructureBase, IShellMaterial //A.1
	{
		...
		public IShellMaterial Clone()
		{
			...
			return new MicrostructureShell2D((IdegenerateRVEbuilder)rveBuilder.Clone(new_rve_id), createSolver, EstimateOnlyLinearResponse,database_size);
		}
