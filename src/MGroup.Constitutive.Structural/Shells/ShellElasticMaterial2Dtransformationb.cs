...
namespace MGroup.Constitutive.Structural.Shells
{
	...
	public class ShellElasticMaterial2Dtransformationb : IShellMaterial
	{
		...
		public ShellElasticMaterial2Dtransformationb(double youngModulus, double poissonRation)
		{
		...
		public IShellMaterial Clone() => new ShellElasticMaterial2Dtransformationb(YoungModulus, PoissonRatio);

		public double[] UpdateConstitutiveMatrixAndEvaluateResponse(double[] cartesianStrains) //TODO: rename cartesian strains to strains 
		{
