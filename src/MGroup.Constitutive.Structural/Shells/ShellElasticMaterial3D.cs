...
namespace MGroup.Constitutive.Structural.Shells
{
	...
	public class ShellElasticMaterial3D : IShellMaterial 
	{
		...
		public double ShearCorrectionCoefficientK { get; }
		...
		public ShellElasticMaterial3D(double youngModulus, double poissonRation, double shearCorrectionCoefficientK)
		{
			this.PoissonRatio = poissonRation;
			this.YoungModulus = youngModulus;
			this.ShearCorrectionCoefficientK = shearCorrectionCoefficientK;
			currentState = new GenericConstitutiveLawState(this, new (string, double)[0]);
		}

		object ICloneable.Clone() => Clone();

		public IShellMaterial Clone() => new ShellElasticMaterial3D(YoungModulus, PoissonRatio, ShearCorrectionCoefficientK);

		public double[] UpdateConstitutiveMatrixAndEvaluateResponse(double[] GLvec)
		{
