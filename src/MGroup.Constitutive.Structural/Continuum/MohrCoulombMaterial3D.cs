...
namespace MGroup.Constitutive.Structural.Continuum
{
	...
	/// </summary>
	public class MohrCoulombMaterial3D : IIsotropicContinuumMaterial3D
	{
		#region GenericConstitutiveLawState state variables
		...
		private const string CONSTITUTIVE_MATRIX_00 = "Constitutive matrix 0,0";
		private const string CONSTITUTIVE_MATRIX_01 = "Constitutive matrix 0,1";
		private const string CONSTITUTIVE_MATRIX_02 = "Constitutive matrix 0,2";
		private const string CONSTITUTIVE_MATRIX_03 = "Constitutive matrix 0,3";
		private const string CONSTITUTIVE_MATRIX_04 = "Constitutive matrix 0,4";
		private const string CONSTITUTIVE_MATRIX_05 = "Constitutive matrix 0,5";
		private const string CONSTITUTIVE_MATRIX_10 = "Constitutive matrix 1,0";
		private const string CONSTITUTIVE_MATRIX_11 = "Constitutive matrix 1,1";
		private const string CONSTITUTIVE_MATRIX_12 = "Constitutive matrix 1,2";
		private const string CONSTITUTIVE_MATRIX_13 = "Constitutive matrix 1,3";
		private const string CONSTITUTIVE_MATRIX_14 = "Constitutive matrix 1,4";
		private const string CONSTITUTIVE_MATRIX_15 = "Constitutive matrix 1,5";
		private const string CONSTITUTIVE_MATRIX_20 = "Constitutive matrix 2,0";
		private const string CONSTITUTIVE_MATRIX_21 = "Constitutive matrix 2,1";
		private const string CONSTITUTIVE_MATRIX_22 = "Constitutive matrix 2,2";
		private const string CONSTITUTIVE_MATRIX_23 = "Constitutive matrix 2,3";
		private const string CONSTITUTIVE_MATRIX_24 = "Constitutive matrix 2,4";
		private const string CONSTITUTIVE_MATRIX_25 = "Constitutive matrix 2,5";
		private const string CONSTITUTIVE_MATRIX_30 = "Constitutive matrix 3,0";
		private const string CONSTITUTIVE_MATRIX_31 = "Constitutive matrix 3,1";
		private const string CONSTITUTIVE_MATRIX_32 = "Constitutive matrix 3,2";
		private const string CONSTITUTIVE_MATRIX_33 = "Constitutive matrix 3,3";
		private const string CONSTITUTIVE_MATRIX_34 = "Constitutive matrix 3,4";
		private const string CONSTITUTIVE_MATRIX_35 = "Constitutive matrix 3,5";
		private const string CONSTITUTIVE_MATRIX_40 = "Constitutive matrix 4,0";
		private const string CONSTITUTIVE_MATRIX_41 = "Constitutive matrix 4,1";
		private const string CONSTITUTIVE_MATRIX_42 = "Constitutive matrix 4,2";
		private const string CONSTITUTIVE_MATRIX_43 = "Constitutive matrix 4,3";
		private const string CONSTITUTIVE_MATRIX_44 = "Constitutive matrix 4,4";
		private const string CONSTITUTIVE_MATRIX_45 = "Constitutive matrix 4,5";
		private const string CONSTITUTIVE_MATRIX_50 = "Constitutive matrix 5,0";
		private const string CONSTITUTIVE_MATRIX_51 = "Constitutive matrix 5,1";
		private const string CONSTITUTIVE_MATRIX_52 = "Constitutive matrix 5,2";
		private const string CONSTITUTIVE_MATRIX_53 = "Constitutive matrix 5,3";
		private const string CONSTITUTIVE_MATRIX_54 = "Constitutive matrix 5,4";
		private const string CONSTITUTIVE_MATRIX_55 = "Constitutive matrix 5,5";
#endregion
		...
		public MohrCoulombMaterial3D(double youngModulus, double poissonRatio, double cohesion, double friction, double dilation)
		{
			...
			currentState = new GenericConstitutiveLawState(this, new[]
			{
				...
				(STRESS_XZ, 0d),
				(STRESS_YZ, 0d),
				(CONSTITUTIVE_MATRIX_00, constitutiveMatrix[0, 0]),
				(CONSTITUTIVE_MATRIX_01, constitutiveMatrix[0, 1]),
				(CONSTITUTIVE_MATRIX_02, constitutiveMatrix[0, 2]),
				(CONSTITUTIVE_MATRIX_03, constitutiveMatrix[0, 3]),
				(CONSTITUTIVE_MATRIX_04, constitutiveMatrix[0, 4]),
				(CONSTITUTIVE_MATRIX_05, constitutiveMatrix[0, 5]),
				(CONSTITUTIVE_MATRIX_10, constitutiveMatrix[1, 0]),
				(CONSTITUTIVE_MATRIX_11, constitutiveMatrix[1, 1]),
				(CONSTITUTIVE_MATRIX_12, constitutiveMatrix[1, 2]),
				(CONSTITUTIVE_MATRIX_13, constitutiveMatrix[1, 3]),
				(CONSTITUTIVE_MATRIX_14, constitutiveMatrix[1, 4]),
				(CONSTITUTIVE_MATRIX_15, constitutiveMatrix[1, 5]),
				(CONSTITUTIVE_MATRIX_20, constitutiveMatrix[2, 0]),
				(CONSTITUTIVE_MATRIX_21, constitutiveMatrix[2, 1]),
				(CONSTITUTIVE_MATRIX_22, constitutiveMatrix[2, 2]),
				(CONSTITUTIVE_MATRIX_23, constitutiveMatrix[2, 3]),
				(CONSTITUTIVE_MATRIX_24, constitutiveMatrix[2, 4]),
				(CONSTITUTIVE_MATRIX_25, constitutiveMatrix[2, 5]),
				(CONSTITUTIVE_MATRIX_30, constitutiveMatrix[3, 0]),
				(CONSTITUTIVE_MATRIX_31, constitutiveMatrix[3, 1]),
				(CONSTITUTIVE_MATRIX_32, constitutiveMatrix[3, 2]),
				(CONSTITUTIVE_MATRIX_33, constitutiveMatrix[3, 3]),
				(CONSTITUTIVE_MATRIX_34, constitutiveMatrix[3, 4]),
				(CONSTITUTIVE_MATRIX_35, constitutiveMatrix[3, 5]),
				(CONSTITUTIVE_MATRIX_40, constitutiveMatrix[4, 0]),
				(CONSTITUTIVE_MATRIX_41, constitutiveMatrix[4, 1]),
				(CONSTITUTIVE_MATRIX_42, constitutiveMatrix[4, 2]),
				(CONSTITUTIVE_MATRIX_43, constitutiveMatrix[4, 3]),
				(CONSTITUTIVE_MATRIX_44, constitutiveMatrix[4, 4]),
				(CONSTITUTIVE_MATRIX_45, constitutiveMatrix[4, 5]),
				(CONSTITUTIVE_MATRIX_50, constitutiveMatrix[5, 0]),
				(CONSTITUTIVE_MATRIX_51, constitutiveMatrix[5, 1]),
				(CONSTITUTIVE_MATRIX_52, constitutiveMatrix[5, 2]),
				(CONSTITUTIVE_MATRIX_53, constitutiveMatrix[5, 3]),
				(CONSTITUTIVE_MATRIX_54, constitutiveMatrix[5, 4]),
				(CONSTITUTIVE_MATRIX_55, constitutiveMatrix[5, 5]),
			});
		}
		...
		public GenericConstitutiveLawState CurrentState
		{
			...
			set
			{
				...
				constitutiveMatrix[0, 0] = currentState.StateValues[CONSTITUTIVE_MATRIX_00];
				constitutiveMatrix[0, 1] = currentState.StateValues[CONSTITUTIVE_MATRIX_01];
				constitutiveMatrix[0, 2] = currentState.StateValues[CONSTITUTIVE_MATRIX_02];
				constitutiveMatrix[0, 3] = currentState.StateValues[CONSTITUTIVE_MATRIX_03];
				constitutiveMatrix[0, 4] = currentState.StateValues[CONSTITUTIVE_MATRIX_04];
				constitutiveMatrix[0, 5] = currentState.StateValues[CONSTITUTIVE_MATRIX_05];
				constitutiveMatrix[1, 0] = currentState.StateValues[CONSTITUTIVE_MATRIX_10];
				constitutiveMatrix[1, 1] = currentState.StateValues[CONSTITUTIVE_MATRIX_11];
				constitutiveMatrix[1, 2] = currentState.StateValues[CONSTITUTIVE_MATRIX_12];
				constitutiveMatrix[1, 3] = currentState.StateValues[CONSTITUTIVE_MATRIX_13];
				constitutiveMatrix[1, 4] = currentState.StateValues[CONSTITUTIVE_MATRIX_14];
				constitutiveMatrix[1, 5] = currentState.StateValues[CONSTITUTIVE_MATRIX_15];
				constitutiveMatrix[2, 0] = currentState.StateValues[CONSTITUTIVE_MATRIX_20];
				constitutiveMatrix[2, 1] = currentState.StateValues[CONSTITUTIVE_MATRIX_21];
				constitutiveMatrix[2, 2] = currentState.StateValues[CONSTITUTIVE_MATRIX_22];
				constitutiveMatrix[2, 3] = currentState.StateValues[CONSTITUTIVE_MATRIX_23];
				constitutiveMatrix[2, 4] = currentState.StateValues[CONSTITUTIVE_MATRIX_24];
				constitutiveMatrix[2, 5] = currentState.StateValues[CONSTITUTIVE_MATRIX_25];
				constitutiveMatrix[3, 0] = currentState.StateValues[CONSTITUTIVE_MATRIX_30];
				constitutiveMatrix[3, 1] = currentState.StateValues[CONSTITUTIVE_MATRIX_31];
				constitutiveMatrix[3, 2] = currentState.StateValues[CONSTITUTIVE_MATRIX_32];
				constitutiveMatrix[3, 3] = currentState.StateValues[CONSTITUTIVE_MATRIX_33];
				constitutiveMatrix[3, 4] = currentState.StateValues[CONSTITUTIVE_MATRIX_34];
				constitutiveMatrix[3, 5] = currentState.StateValues[CONSTITUTIVE_MATRIX_35];
				constitutiveMatrix[4, 0] = currentState.StateValues[CONSTITUTIVE_MATRIX_40];
				constitutiveMatrix[4, 1] = currentState.StateValues[CONSTITUTIVE_MATRIX_41];
				constitutiveMatrix[4, 2] = currentState.StateValues[CONSTITUTIVE_MATRIX_42];
				constitutiveMatrix[4, 3] = currentState.StateValues[CONSTITUTIVE_MATRIX_43];
				constitutiveMatrix[4, 4] = currentState.StateValues[CONSTITUTIVE_MATRIX_44];
				constitutiveMatrix[4, 5] = currentState.StateValues[CONSTITUTIVE_MATRIX_45];
				constitutiveMatrix[5, 0] = currentState.StateValues[CONSTITUTIVE_MATRIX_50];
				constitutiveMatrix[5, 1] = currentState.StateValues[CONSTITUTIVE_MATRIX_51];
				constitutiveMatrix[5, 2] = currentState.StateValues[CONSTITUTIVE_MATRIX_52];
				constitutiveMatrix[5, 3] = currentState.StateValues[CONSTITUTIVE_MATRIX_53];
				constitutiveMatrix[5, 4] = currentState.StateValues[CONSTITUTIVE_MATRIX_54];
				constitutiveMatrix[5, 5] = currentState.StateValues[CONSTITUTIVE_MATRIX_55];
			}
		}
		...
		public object Clone()
		{
			...
			var m = new MohrCoulombMaterial3D(this.youngModulus, this.poissonRatio, this.cohesion, this.friction, this.dilation)
			{
