...
namespace MGroup.Constitutive.Structural.ContinuumElements
{
	/// <summary>
	...
	public class ElasticMaterial3DDefGrad : IContinuumMaterial3DDefGrad
	{
		...
		public object Clone()
		{
			return new ElasticMaterial3DDefGrad() { YoungModulus = this.YoungModulus, PoissonRatio = this.PoissonRatio };
		}
